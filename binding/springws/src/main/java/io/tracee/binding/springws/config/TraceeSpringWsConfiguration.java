...
public class TraceeSpringWsConfiguration {
	...
	private static class WebServiceTemplatePostProcessor implements BeanPostProcessor {

		private final TraceeClientInterceptor interceptor;

		private WebServiceTemplatePostProcessor(TraceeClientInterceptor interceptor) {
